...
<head>
  ...
  <title>Arianoi — PT Sinar Langit Hanoi (EN)</title>
...
<header>
  ...
  <!-- Hamburger visible on all screen sizes to keep header clean -->
  ...
  <!-- Menu is hidden by default; includes nav links and language buttons -->
  <nav class="nav-menu" id="menu" aria-label="Main navigation" aria-hidden="true">
    ...
    <div class="lang-switch" role="group" aria-label="Language switch">
      ...
      <button aria-pressed="false" data-lang="id" title="Indonesian" onclick="location.href='../id/index.html'">ID</button>
    </div>
  </nav>
</header>
...
<main>
  <section class="hero">
    <h1>Empowering your business with smarter growth across Southeast Asia</h1>
    <p class="subtitle">We help businesses grow stronger through clear strategies and trusted partnership.</p>

    <a class="btn-primary" href="https://form.arianoi.com/1.php" target="_blank" rel="noopener">Start Service</a>
  </section>
  ...
  <section class="contact-section" aria-labelledby="contact-heading">
    ...
    <p>Address: Jl. Nakula, PT Sinar Langit Hanoi, Tanjunganom, Nganjuk, Jawa Timur, Indonesia 64483</p>
  </section>
</main>
...
<script>
/* Menu toggle — keeps header clean. Language buttons live inside menu.
   This script updates aria attributes and closes menu on outside click or ESC. */
(function () {
  ...
  // language button behavior: visually mark active (client-side).
  langButtons.forEach(function (b) {
    b.addEventListener('click', function (e) {
      // If the button has a navigation (like the ID button above), the page will navigate.
      // Otherwise, just mark active state.
